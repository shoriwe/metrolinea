...
func CreateUser(controller *data.Controller) http.HandlerFunc {
	return func(responseWriter http.ResponseWriter, request *http.Request) {
		...
		var createUserForm forms.AdminCreateUserForm
		unmarshalError := json.Unmarshal(body, &createUserForm)
		...
		succeed, message, updateError := controller.AdminCreateUser(request, createUserForm)
		if updateError != nil {
