...
func UpdateUserPassword(controller *data.Controller) http.HandlerFunc {
	return func(responseWriter http.ResponseWriter, request *http.Request) {
		...
		var updateUserPasswordForm forms.AdminUpdateUserPasswordForm
		unmarshalError := json.Unmarshal(body, &updateUserPasswordForm)
		...
		succeed, message, updateError := controller.AdminUpdateUserPassword(request, updateUserPasswordForm.Cookies, updateUserPasswordForm.Username, updateUserPasswordForm.NewPassword)
		if updateError != nil {
