...
func AddTerminals(controller *data.Controller) http.HandlerFunc {
	return func(responseWriter http.ResponseWriter, request *http.Request) {
		...
		var addTerminalsForm forms.AdminAddTerminalsForm
		unmarshalError := json.Unmarshal(body, &addTerminalsForm)
		...
		succeed, message, updateError := controller.AdminAddTerminals(request, addTerminalsForm.Cookies, addTerminalsForm.Terminals)
		if updateError != nil {
