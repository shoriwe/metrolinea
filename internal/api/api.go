...
func NewHandler(controller *data.Controller) *http.ServeMux {
	...
	// ToDo: handler.HandleFunc("/admin/delete/terminals", admin.DeleteTerminals(controller))
	// ToDo: handler.HandleFunc("/admin/delete/routes", admin.DeleteRoutes(controller))
